 ...
 */
public abstract class GenericHibernateDAO<MODEL extends IModel<ID>, ID extends Serializable>
    ...
    public GenericHibernateDAO() {
        try {
            ...
            System.err.println("(GenericHibernateDAO() -> this.persistentClass) Can't cast! "+ex);
        }
    }
